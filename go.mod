module github.com/yearm/kratos-pkg
...
require (
	...
	github.com/go-kratos/kratos/contrib/log/logrus/v2 v2.0.0-20230307155106-51fac4ff9003
	...
	gorm.io/plugin/opentelemetry v0.1.5-0.20240410095124-cecb698bba6a
	k8s.io/api v0.26.2
